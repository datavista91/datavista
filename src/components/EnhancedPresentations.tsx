...
const EnhancedPresentations = () => {
  ...
  useEffect(() => {
    if (selectedPresentation) {
      const generatedSlides = EnhancedSlideParser.parseAIResponseToSlides(
  ...
  const handlePresentationSelect = useCallback((presentation: any) => {
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center h-96 text-center bg-white rounded-lg border border-gray-200">
          ...
          <p className="text-gray-600 mb-4 max-w-md">
            Ask the AI to create presentations about your data. Try requesting slide decks, 
            reports, or visual summaries of your analysis.
          </p>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6">
        {aiPresentations.map((presentation) => (
          <div key={presentation.id} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow relative">
            {/* New Tag - Top Right */}
            {presentation.isNew && (
