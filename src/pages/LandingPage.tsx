...
const LandingPage = () => {
   ...
   return (
      <div className='bg-main'>
         {/* Header */}
         <header className='fixed top-0 left-0 right-0 z-50 bg-surface/90 backdrop-blur-md border-b border-main'>
            <nav className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between'>
               ...
               <div className='flex items-center space-x-4'>
                  <a
                     href='/login'
                     className='bg-cyan text-main rounded-md px-4 py-2 text-sm font-medium hover:bg-cyan-dark transition-colors'
                  >
                     Sign in with Google
                  </a>
               </div>
         ...
         <footer className='bg-surface border-t border-main text-secondary'>
