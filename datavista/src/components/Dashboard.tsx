            ...
            >
              <div className='flex items-center justify-between mb-2'>
                <span className='text-sm font-medium text-gray-700'>
                  {analysisData.analysisType === 'full' ? 'Full analysis in progress...' :
                   analysisData.analysisType === 'quick' ? 'Quick overview in progress...' :
                   analysisData.analysisType === 'visualization' ? 'Preparing visualizations...' :
